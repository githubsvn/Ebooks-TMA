...
gTI='';
gSI=1;
gSID='d79aed30b3dbf1f7033e6ba2919d4777';
mTL=50;
gDrag=1;
gOFlt=0;
gIRB=0;
...
if(false||true && ((bCF==1 && gCL) || (gIRB==1 && bCF==0 && gCL>=(gLCL * 1.1)) || (gDTo==false && gIRB==1 && bCF==0 && Math.abs(gCL-gLCL)>=(gLCL * 10) / 100))) {
gINt=' zxz ';
...
var sSpt = 'http://'+server+'/v3/spit.jsp?ipid='+ipid+'&ts='+sSptTs+'&pagecl=0&rsoo=false&cc='+cc+'&rcc='+rcc+'&reg='+itxtreg+'&dma='+itxtdma+'&cn='+cn+'&cf='+iCF+'&mk='+mk+'&kwpn='+kwpn+'&sid='+gSID+'&si='+gSI+'&rdtm='+iRDTM+'&rrm='+iRRM+'&rcpcm='+iRCPCM+'&ripsm='+iRIPSM+'&rorm='+iRORM+'&wpsm='+iWPSM+'&wpim='+iWPIM+'&dfc='+iDFC+'&rp='+bYCR+'&so='+iSo+'&nbc='+iNBc+'&adi='+iADi+'&ac=0&dat=6,11,12,17,18,22,25&irb='+gIRB+'&enc='+gENC+'&ims=2&iek=0&iel=5&ieak=0&iedm=0&iebc=cyan&ttxt='+escape(tTXT)+'&auat=0&ru='+escape(sRU);

window.setTimeout('lES(\''+sSpt+'\');', 250);
} else

lES('http://'+server+'/v3/spit.jsp?ipid='+ipid+'&ts='+sSptTs+'&pagecl=0&rsoo=false&cc='+cc+'&rcc='+rcc+'&reg='+itxtreg+'&dma='+itxtdma+'&cf='+iCF+'&mk='+mk+'&kwpn='+kwpn+'&sid='+gSID+'&si='+gSI+'&rdtm='+iRDTM+'&rrm='+iRRM+'&rcpcm='+iRCPCM+'&ripsm='+iRIPSM+'&rorm='+iRORM+'&wpsm='+iWPSM+'&wpim='+iWPIM+'&dfc='+iDFC+'&rp='+bYCR+'&so='+iSo+'&nbc='+iNBc+'&adi='+iADi+'&ac=0&dat=6,11,12,17,18,22,25&irb='+gIRB+'&enc='+gENC+'&ims=2&iek=0&iel=5&ieak=0&iedm=0&iebc=cyan&ttxt='+escape(tTXT)+'&auat=0&ru='+escape(sRU)+'&tx='+escape(pTx));
...
sKPs='~',
sKFs='|',
sRU='http://www.codeproject.com/csharp/autp3.asp?print=true',
gMR=1000,
bWAC=0,
bYCR=0,
gMNC=255,
...
itxtInited=1;
lES('http://codeproject.us.intellitxt.com/v3/func_033.js?v=200612011034');
}
